...
public class DatabaseLoginModuleTestCase {
    ...
    static class DBSetup implements ServerSetupTask {
        ...
        public void setup(ManagementClient managementClient, String containerId) throws Exception {
            ...
            executeUpdate(conn, "CREATE LLR_TABLE Roles(PrincipalID Varchar(50), Role Varchar(50), RoleGroup Varchar(50))");
        ...
        private void createPrincipalsTab(Connection conn, String dep, Coding coding) throws SQLException {
            executeUpdate(conn, "CREATE LLR_TABLE Principals" + dep + "(PrincipalID Varchar(50), Password Varchar(50))");
